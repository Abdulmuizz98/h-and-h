...
const cardData = [
  ...
  {
    classes: "justify-content-xl-center align-items-xl-end",
    src: ringsEarrings,
    title: "Quality",
    details:
    ...
    <section id="about" className="">
      <div className="container">
        ...
        <div className="row gy-5 ">
          <div className="col-lg d-flex justify-content-center justify-content-lg-start">
            <Frame
              img={necklaceTwo}
          ...
          <div className="col-lg d-flex justify-content-center align-items-center">
            <div className="custom-col d-flex justify-content-center align-items-end px-5 py-4">
              <p className="fs-sm-2 fs-md-2 text-center fw-light lh-1 m-0">
          ...
          <div className="col-lg d-flex justify-content-center justify-content-lg-end">
            <Frame
              img={necklaceOne}
              classes="w-xl-344 h-xl-476 px-2 py-3 px-md-3 py-md-4 px-xl-17 py-xl-27 bord"
      ...
      <div className="container">
        <h2 className="mt-50 mt-md-100 ff-serif fw-bold fs-sm-5 fs-md-4 fs-xl-6 text-center">
          Why Choose Us
        </h2>
        <div className="row gy-5 m-0 h-xl-684 justify-content-between">
          {cardData.length &&
            cardData.map((item, index) => (
              <div
                key={index}
                className={`col-lg p-0 d-flex justify-content-center ${item.classes}`}
              >
                <Card
                  src={item.src}
                  title={item.title}
